    ...
    loadWindBar() {
        return new Promise((resolve, reject) => {
            ...
            image0.onload = () => {
                ...
                const windBarTexture = this.windBarTexture = createTexture(this.gl, this.gl.LINEAR/*this.gl.NEAREST*//*fixme:用LINEAR效果能好些*/, barData, image0.width, image0.height, TEXTURE_INDEX_WINDBAR, this.gl.RGBA);
