...
export class WebGL {
    ...
    public createTexture(index: number, width: number, height: number, internalFormat: number, format: number, type: number, filter: number, data: ArrayBufferView | null): WebGLTexture | null {
        const gl = this.gl;
    ...
    public createColorRamp(colors: Array<any>): Uint8Array {
