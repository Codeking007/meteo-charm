type BufferData = number | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | null;
export class WebGL{
    ...
    public createTwinsFbo(id:number,width:number,height:number,internalFormat:number,format:number,type:number,param:number,data:ArrayBufferView | null):GLTwinsFbo{
        return new GLTwinsFbo(this.gl,this.createFBO(id,width,height,internalFormat,format,type,param,data),this.createFBO(id+1,width,height,internalFormat,format,type,param,null));
    }
     ...
     * @param {number} a_pos
     */
    public drawQuad(attribute: number,buffer:WebGLBuffer) {
        const gl = this.gl;
