type BufferData = Int8Array | Int16Array  | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array| Float64Array| DataView| ArrayBuffer| null;
...
export class WebGL {
    ...
    public createTexture(index: number, width: number, height: number, internalFormat: number, format: number, type: number, filter: number, data: ArrayBufferView | TexImageSource | null): WebGLTexture | null {
        ...
        if (data == null || data instanceof Uint8Array) {
            gl.texImage2D(gl.TEXTURE_2D, 0, internalFormat, width, height, 0, format, type, data as any);    // todo 怎么参数变多了
        } else {
