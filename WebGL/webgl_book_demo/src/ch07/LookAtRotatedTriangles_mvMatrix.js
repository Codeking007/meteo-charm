...
// fixme:上面只是为了展示模型视图矩阵，实际只需一行代码
  // fixme:var modelViewMatrix = new Matrix4();
  // fixme:modelViewMatrix.setLookAt(0.20, 0.25, 0.25, 0, 0, 0, 0, 1, 0).rotate(-10, 0, 0, 1);
  // fixme:gl.uniformMatrix4fv(u_ModelViewMatrix,false,modelViewMatrix.elements);
  // Clear <canvas>
