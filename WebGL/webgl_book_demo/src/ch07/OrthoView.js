...
// fixme:可视空间:即可视范围,有两类常用的可视空间
// fixme:(1)正射投影(orthographic projection):长方体可视空间,也称盒状空间
// fixme:盒状空间:由前后两个矩形表面确定,分别称为近裁剪面(near clipping plane)和远裁剪面(far clipping plane)
// fixme:定义盒状可视空间(正射投影矩阵)==>Martix4.setOrtho(left,right,bottom,top,near,far)
// fixme:(2)透视投影(perspective projection):四棱锥/金字塔可视空间
// fixme:定义透视投影可视空间(透视投影矩阵)==>Martix4.setPerspective(fovy, aspect, near, far)
